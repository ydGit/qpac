...
In quantum physics \emph{teleportation} means creation of a given quantum state at a far away place. It important to understand that quantum teleportation does not imply sending objects or energy instanteneously from one place to another.
