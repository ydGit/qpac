...
\begin{figure}[htbp]
	...
	\caption{Usual numbers are, in a certain sense, special case of \emph{linear operators} -- mathematical objects explored later in the book.}
...
\subsection{States And Hidden Variables}
