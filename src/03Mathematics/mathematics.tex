...
Suppose we have 100 fair dice and toss them all at once. Denoting the sum total of face values as $V$, we can state that it can be anywhere from 100 to 600, although neither of these extreme values is likely.
