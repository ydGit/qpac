...
\]
 ...
 Turns out, in many cases it is possible. We will consider a couple of most important and relatively simple examples: trigonometric functions and polynomials.
...
\subsection{Solution}
When the angular speed $\omega$ is constant, the equation of circular motion can be easily solved.  The simple solution will play an important part in quantum theory.
\[
