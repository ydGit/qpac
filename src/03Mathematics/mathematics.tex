...
It is easy to create a perfect correlation between Alex and Bella if they can communicate. For instance, if they meet and agree to choose the same juice on each day, then flip a coin to determine which one, then we would observe the behavior described by the state $\ket{T_0}$. 
