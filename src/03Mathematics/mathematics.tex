...
\begin{exercise}
	...
	f\,M\,m\,r=Mm/r^2\,.
	\]
	Express it purely in terms of the binary function \btc{mul}.
\end{exercise}
...
Some functions are simpler than others. Among the simplest kinds of functions, \emph{linear functions} are of special importance. Such functions have the following properties:
\[
