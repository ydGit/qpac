...
To make notation used in quantum physics feel less foreign we will introduce it early and in a more familiar setting. To this end, consider a scenario where a student, let's call her Alex, goes to a vending machine to buy a glass of juice. The machine offers three options: (1) A pure apple juice, (2) a pure orange juice, and (3) a 50/50 mix of both, as shown in Fig. \ref{fig:correlations}.
\begin{figure}[htbp]
	\centering
