...
\lettrine[lines=2]{\color{darkocre}B}{efore starting the journey towards quantum physics it is} worth   taking a quick look at physics as a branch of science and see what basic assumptions, ideas, and tools lie at its foundation. Since quantum physics changes our understanding of nature and our relationship with it, we should get a better understanding of those physical concepts that get most affected.
...
\section{Measurement}
State of a system is closely related to the \emph{knowledge} of its possible behavior. Where does that knowldege come from? In physics the primary source of quantative knowledge comes from experiments. Dutch experimental physicist Heike Kamerlingh Onnes, who received 1913 Nobel Prize in physics "for his investigations on the properties of matter at low temperatures which led, inter alia, to the production of liquid helium,"   put it as follows: \emph{Door meten tot weten} or \emph{Through measurement to knowing}.
...
Photons and electrons have certain characteristics which are not related to the "usual" motion through space with time. In technical jargon, they have \emph{non-spatiotemporal degrees of freedom}.
