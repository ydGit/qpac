...
In this book you will encounter several examples of notation that might appear unusual. This is done on purpose.
One example is when instead of the monstrous sigma ($\Sigma$) notation for the summation:
\[
S = \sum\limits_{i=1}^{i=N} a_i
\]
